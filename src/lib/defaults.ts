...
export const NewCharacter = (): Character => ({
  ...
  secSkills: {
    'Demon Lore': skill(Attrs.INT),
    'Dragon Lore': skill(Attrs.INT),
    'Silver Tongue': skill(Attrs.INT),
    'Geography & Culture': skill(Attrs.INT),
    Courtesy: skill(Attrs.CHA),
    Intrigue: skill(Attrs.CHA),
    Teacher: skill(Attrs.INT),
    Observation: skill(Attrs.INT),
    Reputation: skill(Attrs.CHA),
    Skiing: skill(Attrs.CHA),
  },
  armour: {
    name: '',
    rating: 0,
